...
export default function MainHeader() {
  ...
  const navigation = {
    ...
    pages: [
      { name: "Company Registeration", href: "/company-registration" },
      { name: "Pricing", href: "/pricing" },
    ],
  };

  // const getCategories = async () => {
  //   const res = await axios.get("http://localhost:50000/category/list");
  //   setNav(res.data);
  // };
                    ...
                    >
                      ...
                      {category.sections.map((section) => (
                        <div key={section.name}>
                          <p
                            id={`${category.id}-${section._id}-heading-mobile`}
                          ...
                          <ul
                            role="list"
                            aria-labelledby={`${category.id}-${section._id}-heading-mobile`}
        ...
        <nav aria-label="Top" className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <div className="h-16 flex items-center">
              ...
              {/* Logo */}
              <div className="ml-4 flex " tw="lg:ml-0">
                <Link to="/">
              ...
              <div className="ml-auto flex items-center">
                ...
                <Popover className="flex">
                  <Transition
                    ...
                    show={searchOpen}
                  >
                    <Popover.Panel className="absolute bg-white shadow-md top-full inset-x-0 text-sm text-gray-500">
                      <div className="py-2 px-2">
                        <input
                          placeholder="Search here..."
                          className="w-full p-2 outline-none bg-gray-200 text-black placeholder-indigo-900 font-medium"
                        />
                      </div>
                    </Popover.Panel>
                  </Transition>
                ...
                <Popover.Group className="lg:ml-8 lg:block lg:self-stretch">
                  <div className="h-full flex space-x-8 ">
                    <Popover key={"searchbarpop"} className="flex">
                      <div className="relative flex">
                        <Popover.Button
                          className={
                        ...
                        <Popover.Panel className="absolute top-full inset-x-0 text-sm text-gray-500">
                          ...
                          <div className="relative bg-white">
                            <div className="max-w-7xl mx-auto px-2">
                              <div className="grid grid-cols-1 gap-y-10 gap-x-8 py-2">
                                <input
                                  placeholder="Search here..."
                                  className="w-full p-2 outline-none bg-gray-200 text-black placeholder-indigo-900 font-medium"
                                />
